...
function generate(config, dir) {
    ...
    if (language.some((item) => constants_1.LANGUAGES_NEED_WORDCUT.includes(item))) {
        constantContents.push(`lunr.wordcut = require(${JSON.stringify(require.resolve("lunr-languages/wordcut"))});`);
    }
